		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="intro-text">
					<h1 class="name">confirm&nbsp&nbspPick&nbsp;&nbsp;Up&nbsp&nbspitems</h1>
					<hr>
					<span class="skills page-scroll font"> <a
						...
						&nbsp&nbsp&nbsp <a href="#join" style="color: white">습득물 확인</a>
						&nbsp&nbsp&nbsp - &nbsp&nbsp&nbsp <a href="ReadLostItem"
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 text-center">
				<h2 class="font">습득물 목록</h2>
				<hr class="star-primary">
			</div>
		</div>
		<c:if test="${FIND_LIST.listsize - 1 >= 0}">

			<c:forEach var="cnt" begin="0" end="${FIND_LIST.listsize - 1}">
				<br>
					...
					<table class="font"
						...
						<tr>
							<td
								...
								습득 장소</td>
							<td style="padding-left: 50px; font-size: 20px;">
								${FIND_LIST.findplace[cnt]}</td>
							<td
								style="padding-left: 50px; font-size: 21px; font-weight: bold;">
								보관 장소</td>
							<td style="padding-left: 50px; font-size: 20px;">
								${FIND_LIST.storage[cnt]}</td>
						</tr>
						<tr>
							<td
								style="padding-left: 100px; font-size: 21px; font-weight: bold;">
								습득 날짜</td>
							<td style="padding-left: 50px; font-size: 20px;">
								${FIND_LIST.finddate[cnt]}</td>
							<td
								style="padding-left: 50px; font-size: 21px; font-weight: bold;">
								연락처</td>
							<td style="padding-left: 50px; font-size: 20px;">
								${FIND_LIST.phone[cnt]}</td>
						</tr>
						<tr>
							<td colspan="4"
							...
							<input type="submit" value="FIND" class="btn btn-success btn-lg"
								onclick="location.href='DeleteFindItem?seqno=${FIND_LIST.seqno[cnt]}'" />
							</td>
						</tr>
					</table>
				</div>
		...
		<div class="intro-text" style="text-align: center;">
			<h3 class="name">
				<c:if test="${!FIND_LIST.lastpage}">
					<span class="skills page-scroll font"> <a
						href='ReadFindItem?LAST_SEQ_NO=${FIND_LIST.seqno[FIND_LIST.listsize - 1]}'>
							다음 페이지 </a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</span>
				</c:if>
				<c:if test="${!FIND_LIST.startpage}">
