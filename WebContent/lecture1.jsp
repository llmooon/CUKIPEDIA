...
<title>CUKipedia-Lecture Evaluation</title>
...
<body id="page-top" class="index">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="page-scroll"><a href="./CourListServlet">LECTURE LIST</a></li>
	...
	<header class="hi">
		...
		<h1 class="title">${LEC.subject[num-1]}-${LEC.pro[num-1] }교수님</h1>
		<br> <br>
		<div class="tabbable">
			<!-- 왼쪽과 오른쪽 탭에만 필요 -->
			<div class="tab-content">
				<form action="writeServlet" method="POST">
					<div class="a">강의평가</div>
					<br>
					<%
						String temp = request.getParameter("num");
						Integer num = Integer.parseInt(temp);
					%>
					<textarea class="feedback textclass" rows="5" cols="100"
						style="margin: auto;" name="estContent"></textarea>
					<br>
					<br> <a href="./up.jsp?num=<%=num%>"> <span
						class="glyphicon glyphicon-thumbs-up" aria-hidden="true"
						style="text-decoration: none; font-weight: bold; color: #65e9cf;">
							&nbsp;좋아요 </span>
					</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="./down.jsp?num=<%=num%>"> <span
						class="glyphicon glyphicon-thumbs-down" aria-hidden="true"
						style="text-decoration: none; font-weight: bold; color: #e9657c;">
							&nbsp;싫어요 </span>
					</a> <Br>
					<Br>
					<br> <input type="hidden" name="hide" value="<%=num%>" /> <input
						type="submit" class="btn btn-success" value="작성하기" /> <br>
					<br>
					<br>
					<Br>
				</form>
					...
					<div class="tuyin first">
						...
						<div class="text">
							...
							<table class="list" border="1"
								style="width: 80%; background-color: #f5e7cf; color: #ac8f5d; border: 5px solid #ac8f5d">
								<c:if test="${EST.size-1>=0 }">
									<c:forEach var="cnt" begin="0" end="${EST.size-1}">
										<tr>
											<th class="onestyle="border: 5pxsolid #ac8f5d; text-align:center; height: 10px;">
												${EST.est[cnt] }
											</th>
										</tr>
									</c:forEach>
